...
public class StudentController {
    ...
    public ResponseEntity<Student> getStudent(){
        ...
        return ResponseEntity.ok().header("custom-header", "maha").body(student);
    ...
    public ResponseEntity<List<Student>> getStudents(){
        ...
        students.add(new Student(1,"Maha", "Nadigatla"));
        students.add(new Student(2,"Lakshmi", "Nadigatla"));
        students.add(new Student(3, "harshi", "Choudary"));
        students.add(new Student(4,"Ram", "M N"));
